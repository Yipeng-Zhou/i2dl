...
class SGD(object):
    ...
    def _update(self, w, dw, lr):
        """
        Update a model parameter, call by "step(self)".
        """
        w -= lr * dw
        return w
    ...
    def step(self):
        ...
        for name in self.model.grads.keys(): # W1, b1; W2, b2; W3, b3; ...
...
class SGDMomentum(object):
    ...
    def __init__(self, model, loss_func, learning_rate=1e-4, **kwargs):
        ...
        self.lr = learning_rate
        self.grads = None
        self.optim_config = kwargs.pop('optim_config', {}) # delete 'optim_config'
        self._reset()
